...
public class AppConfig {
    ...
    private static String unixChromeDriverPath = properties.getProperty("unix.chrome.driver.path");
    ...
    public static String getUnixChromeDriverPath() {
        return unixChromeDriverPath;
    }
